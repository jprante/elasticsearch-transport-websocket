...
import org.elasticsearch.websocket.http.HttpException;
...
public class NettyHttpChannel implements HttpChannel {
    ...
    public NettyHttpChannel(NettyWebSocketServerTransport transport, Channel channel, org.jboss.netty.handler.codec.http.HttpRequest request) {
